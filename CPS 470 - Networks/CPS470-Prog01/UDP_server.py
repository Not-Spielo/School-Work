## ex: python3 UDP_server.py 127.0.0.1 5555
...
class UDPServer:
    ...
    def setup_socket(self):
        ...
        try:
            ...
            self.socket.settimeout(1)  # Set timeout for receive to allow timer checks
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python3 UDP_server.py <server_ip> <server_port>")
        sys.exit(1)
